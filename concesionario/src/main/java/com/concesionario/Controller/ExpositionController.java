...
public class ExpositionController {
    ...
    public ResponseEntity<ArrayList<ExpositionOutputCod>> listarExposiciones() {
        try {
            ArrayList<ExpositionOutputCod> exposiciones = expositionService.listarExposiciones();
    ...
    public void agregarCocheAExpo(@PathVariable int codExpo, @PathVariable String matricula){
        try{
            expositionService.agregarCocheExpo(codExpo, matricula);
        }
        catch (AlreadyExistsException e){
            System.out.println(e.getMessage());
        } catch (InvalidArgumentException e) {
